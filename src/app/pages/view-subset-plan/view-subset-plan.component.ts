...
@Component({
  selector: 'app-view-subset-plan',
  standalone: false,
  templateUrl: './view-subset-plan.component.html',
  styleUrl: './view-subset-plan.component.scss',
})
export class ViewSubsetPlanComponent {
